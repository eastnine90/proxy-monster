...
func pgDiagnosticMessage(sqlState string) string {
	if name, ok := pgConditionNames[sqlState]; ok {
		return name
	}
	if len(sqlState) >= 2 {
		if class, ok := pgErrorClasses[sqlState[:2]]; ok {
			return class
		}
	}
...
// pgConditionNames: exact SQLSTATE → condition name. This is the complete catalog generated from the
// authoritative PostgreSQL errcodes.txt appendix (every code that carries a condition name), not a curated
// subset — it is a fail-safe UX/identity table, NOT the security boundary (that is the unconditional strip).
// Codes absent here degrade to the class name or the generic redacted message.
var pgConditionNames = map[string]string{
	// Class 00 — successful_completion
	...
	// Class 03 — sql_statement_not_yet_complete
	...
	// Class 09 — triggered_action_exception
	"09000": "triggered_action_exception",
	// Class 0A — feature_not_supported
	"0A000": "feature_not_supported",
	// Class 0B — invalid_transaction_initiation
	"0B000": "invalid_transaction_initiation",
	// Class 0F — locator_exception
	"0F000": "locator_exception",
	"0F001": "invalid_locator_specification",
	// Class 0L — invalid_grantor
	"0L000": "invalid_grantor",
	"0LP01": "invalid_grant_operation",
	// Class 0P — invalid_role_specification
	"0P000": "invalid_role_specification",
	// Class 0Z — diagnostics_exception
	"0Z000": "diagnostics_exception",
	"0Z002": "stacked_diagnostics_accessed_without_active_handler",
	// Class 10 — xquery_error
	"10608": "invalid_argument_for_xquery",
	// Class 20 — case_not_found
	"20000": "case_not_found",
	// Class 21 — cardinality_violation
	...
	// Class 23 — integrity_constraint_violation
	...
	// Class 24 — invalid_cursor_state
	"24000": "invalid_cursor_state",
	// Class 25 — invalid_transaction_state
	...
	// Class 26 — invalid_sql_statement_name
	"26000": "invalid_sql_statement_name",
	// Class 27 — triggered_data_change_violation
	"27000": "triggered_data_change_violation",
	// Class 28 — invalid_authorization_specification
	"28000": "invalid_authorization_specification",
	"28P01": "invalid_password",
	// Class 2B — dependent_privilege_descriptors_still_exist
	"2B000": "dependent_privilege_descriptors_still_exist",
	"2BP01": "dependent_objects_still_exist",
	// Class 2D — invalid_transaction_termination
	"2D000": "invalid_transaction_termination",
	// Class 2F — sql_routine_exception
	"2F000": "sql_routine_exception",
	"2F002": "modifying_sql_data_not_permitted",
	"2F003": "prohibited_sql_statement_attempted",
	"2F004": "reading_sql_data_not_permitted",
	"2F005": "function_executed_no_return_statement",
	// Class 34 — invalid_cursor_name
	"34000": "invalid_cursor_name",
	// Class 38 — external_routine_exception
	"38000": "external_routine_exception",
	"38001": "containing_sql_not_permitted",
	"38002": "modifying_sql_data_not_permitted",
	"38003": "prohibited_sql_statement_attempted",
	"38004": "reading_sql_data_not_permitted",
	// Class 39 — external_routine_invocation_exception
	...
	// Class 3B — savepoint_exception
	"3B000": "savepoint_exception",
	"3B001": "invalid_savepoint_specification",
	// Class 3D — invalid_catalog_name
	"3D000": "invalid_catalog_name",
	// Class 3F — invalid_schema_name
	"3F000": "invalid_schema_name",
	// Class 40 — transaction_rollback
	"40000": "transaction_rollback",
	"40001": "serialization_failure",
	"40002": "transaction_integrity_constraint_violation",
	"40003": "statement_completion_unknown",
	"40P01": "deadlock_detected",
	// Class 42 — syntax_error_or_access_rule_violation
	...
	// Class 54 — program_limit_exceeded
	"54000": "program_limit_exceeded",
	"54001": "statement_too_complex",
	"54011": "too_many_columns",
	"54023": "too_many_arguments",
	// Class 55 — object_not_in_prerequisite_state
	"55000": "object_not_in_prerequisite_state",
	"55006": "object_in_use",
	"55P02": "cant_change_runtime_param",
	"55P03": "lock_not_available",
	"55P04": "unsafe_new_enum_value_usage",
	// Class 57 — operator_intervention
	...
	// Class 58 — system_error
	"58000": "system_error",
	"58030": "io_error",
	"58P01": "undefined_file",
	"58P02": "duplicate_file",
	"58P03": "file_name_too_long",
	// Class F0 — config_file_error
	...
	// Class P0 — plpgsql_error
	"P0000": "plpgsql_error",
	"P0001": "raise_exception",
	"P0002": "no_data_found",
	"P0003": "too_many_rows",
	"P0004": "assert_failure",
	// Class XX — internal_error
	"XX000": "internal_error",
	"XX001": "data_corrupted",
	"XX002": "index_corrupted",
}

// pgErrorClasses: SQLSTATE 2-char class → class name, the coarse fallback so any error still carries its
// class. Every class with an NN000 code in the PostgreSQL errcodes.txt appendix, generated from that source.
